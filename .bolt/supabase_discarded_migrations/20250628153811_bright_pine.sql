/*
  # Ajout de données de test pour l'application boutique

  1. Données ajoutées
    - 2 utilisateurs agents supplémentaires
    - 10 produits de vêtements avec codes-barres
    - 8 clients avec informations complètes
    - 3 ventes d'exemple (payée, partielle, complète)
    - 4 locations d'exemple (réservée, retournée, active, en retard)

  2. Mise à jour des stocks
    - Ajustement automatique des stocks selon les ventes et locations
*/

-- Insérer des utilisateurs de test (en plus de l'admin existant)
...
('650e8400-e29b-41d4-a716-446655440001', 'Robe de Soirée Élégante', 'Robes', 'M', 'Noir', '1234567890123', 1200.00, 150.00, 4, now()),
('650e8400-e29b-41d4-a716-446655440002', 'Costume Homme Classique', 'Costumes', 'L', 'Bleu Marine', '1234567890124', 2500.00, 200.00, 2, now()),
('650e8400-e29b-41d4-a716-446655440003', 'Robe de Mariée Princesse', 'Robes de Mariée', 'S', 'Blanc', '1234567890125', 5000.00, 500.00, 1, now()),
('650e8400-e29b-41d4-a716-446655440004', 'Smoking Homme', 'Costumes', 'XL', 'Noir', '1234567890126', 3000.00, 250.00, 4, now()),
('650e8400-e29b-41d4-a716-446655440005', 'Robe Cocktail Rouge', 'Robes', 'M', 'Rouge', '1234567890127', 800.00, 100.00, 4, now()),
('650e8400-e29b-41d4-a716-446655440006', 'Costume Cérémonie Enfant', 'Enfants', '10 ans', 'Gris', '1234567890128', 600.00, 80.00, 8, now()),
('650e8400-e29b-41d4-a716-446655440007', 'Robe de Soirée Paillettes', 'Robes', 'L', 'Doré', '1234567890129', 1500.00, 180.00, 2, now()),
('650e8400-e29b-41d4-a716-446655440008', 'Costume Trois Pièces', 'Costumes', 'M', 'Charbon', '1234567890130', 2800.00, 220.00, 2, now()),
('650e8400-e29b-41d4-a716-446655440009', 'Robe Demoiselle d''Honneur', 'Robes', 'S', 'Rose Poudré', '1234567890131', 700.00, 90.00, 5, now()),
