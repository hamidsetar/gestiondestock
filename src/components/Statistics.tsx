...
const Statistics: React.FC = () => {
  ...
  const generateAccountingReport = () => {
    ...
    doc.text('RAPPORT COMPTABLE - HALI', 105, 60, { align: 'center' });
    ...
    doc.setFontSize(12);
    doc.setFont('helvetica', 'normal');
    doc.text(`Chiffre d'affaires total: ${stats.totalRevenue.toFixed(2)} DH`, 20, yPosition);
    yPosition += 8;
    doc.text(`Montant encaissé: ${stats.totalPaid.toFixed(2)} DH`, 20, yPosition);
    yPosition += 8;
    doc.text(`Reste à encaisser: ${stats.totalRemaining.toFixed(2)} DH`, 20, yPosition);
    yPosition += 8;
    ...
    yPosition += 6;
    doc.text(`  • Chiffre d'affaires: ${stats.totalSalesRevenue.toFixed(2)} DH`, 25, yPosition);
    yPosition += 10;
    ...
    yPosition += 6;
    doc.text(`  • Chiffre d'affaires: ${stats.totalRentalsRevenue.toFixed(2)} DH`, 25, yPosition);
    yPosition += 20;
    ...
    stats.topProducts.forEach((item, index) => {
      ...
      doc.text(`${item.revenue.toFixed(2)} DH`, 150, yPosition);
    ...
    filteredSales.forEach(sale => {
      ...
      doc.text(`${sale.totalAmount.toFixed(2)} DH`, 150, yPosition);
    ...
    doc.save(`rapport-comptable-hali-${periodLabel}.pdf`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Statistiques & Comptabilité</h1>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Période d'analyse</h2>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalRevenue.toFixed(0)} DH</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalPaid.toFixed(0)} DH</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-2xl font-bold text-gray-900 dark:text-white">{stats.totalRemaining.toFixed(0)} DH</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Reste à encaisser</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Ventes</h3>
          </div>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Nombre:</span>
              <span className="font-medium text-gray-900 dark:text-white">{stats.salesCount}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Chiffre d'affaires:</span>
              <span className="font-medium text-gray-900 dark:text-white">{stats.totalSalesRevenue.toFixed(2)} DH</span>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Locations</h3>
          </div>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Nombre:</span>
              <span className="font-medium text-gray-900 dark:text-white">{stats.rentalsCount}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Chiffre d'affaires:</span>
              <span className="font-medium text-gray-900 dark:text-white">{stats.totalRentalsRevenue.toFixed(2)} DH</span>
            </div>
            <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Top 5 Produits</h3>
          </div>
          <div className="space-y-3">
            {stats.topProducts.slice(0, 5).map((item, index) => (
              <div key={item.product.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{item.quantity} unités vendues</p>
                </div>
                <div className="text-right">
                  <p className="font-medium text-gray-900 dark:text-white">{item.revenue.toFixed(2)} DH</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Top 5 Clients</h3>
          </div>
          <div className="space-y-3">
            {stats.topClients.slice(0, 5).map((item, index) => (
              <div key={item.client.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">{item.transactions} transactions</p>
                </div>
                <div className="text-right">
                  <p className="font-medium text-gray-900 dark:text-white">{item.revenue.toFixed(2)} DH</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">#{index + 1}</p>
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="flex items-center mb-6">
          <PieChart className="w-5 h-5 text-indigo-600 dark:text-indigo-400 mr-2" />
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Évolution Mensuelle</h3>
        </div>
